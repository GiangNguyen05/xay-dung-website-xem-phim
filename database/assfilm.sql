...
INSERT INTO `episode` (`id_epi`, `film_id`, `episode`, `episode_name`, `content`) VALUES
...
INSERT INTO `film` (`id_film`, `name`, `name2`, `status`, `director`, `actor`, `category_id`, `type_movie`, `nation_id`, `year`, `image`, `description`, `duration`, `num_view`, `author`) VALUES
...
(122, 'NÀNG THƠ CỦA QUỶ', 'Muse (2020)', 'Hoàn tất ', 'Không xác định', 'Không xác định', 12, 3, 10, 2018, 'images/p120.png', 'Muse (Nàng Thơ Của Quỷ) được chuyển thể từ quyển tiểu thuyết rùng rợn The Lady Number Thirteencủa cây bút nổi tiếng José Carlos Somoza. Chuyện phim theo chân vị giáo sư văn học Samuel Salomon(Elliot Cowan đóng). Sau cái chết đầy bi kịch đẫm máu của người bạn gái, ông quyết định gác lại công việc. Trong suốt một năm đó, ông thường xuyên gặp phải ác mộng, Sumuel thường xuyên mơ thấy một nhóm người bí ẩn hành hình theo một nghi lễ chết chóc.', 107, 54289, 'Không xác định');
...
CREATE TABLE `nation` (
  ...
  `name_nation` varchar(30) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `nation` (`nation_id`, `name_nation`) VALUES
(1, 'Mỹ'),
(2, 'Việt Nam'),
(3, 'Pháp'),
(4, 'Nhật Bản'),
...
CREATE TABLE `nav-menu` (
  ...
  `name_menu` varchar(255) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `nav-menu` (`id_menu`, `name_menu`, `handle`) VALUES
(1, 'thể loại', 'category'),
(2, 'quốc gia', 'nation'),
...
CREATE TABLE `series-movie` (
  `id_series-movie` int(20) NOT NULL,
  `name_series-movie` varchar(255) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `series-movie` (`id_series-movie`, `name_series-movie`, `year`) VALUES
(1, 'Phim Bộ 2018', 2018),
(2, 'Phim Bộ 2017', 2017),
(3, 'Phim Bộ 2016', 2016),
(4, 'Phim Bộ 2015', 2015);
...
CREATE TABLE `single-movie` (
  `id_single-movie` int(20) UNSIGNED NOT NULL,
  `name_single-movie` varchar(255) CHARACTER SET utf8 NOT NULL,
  `year` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `single-movie` (`id_single-movie`, `name_single-movie`, `year`) VALUES
(1, 'Phim Lẻ 2018', 2018),
(2, 'Phim Lẻ 2017', 2017),
(3, 'Phim Lẻ 2016', 2016),
(4, 'Phim Lẻ 2015', 2015);
...
CREATE TABLE `theater-movie` (
  `id_ theater -movie` int(20) NOT NULL,
  `name_ theater -movie` varchar(255) CHARACTER SET utf32 NOT NULL,
...
INSERT INTO `theater-movie` (`id_ theater -movie`, `name_ theater -movie`, `year`) VALUES
...
INSERT INTO `type-movie` (`id_type`, `name`, `handle`) VALUES
